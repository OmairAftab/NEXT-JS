...
export async function getUserPosts(userId:string){
    ...
    const response = await fetch(`https://jsonplaceholder.typicode.com/posts?userId=${userId}`,{cache:"no-store"});
...
export async function getUserAlbums(userId:string){
    ...
    const response = await fetch(`https://jsonplaceholder.typicode.com/albums?userId=${userId}`,{cache:"no-store"});
...
export default async function UserProfile({params}:{
    ...
    //dont use await here as it will make the requests sequentially and take more time to load the page.
    //  Instead use Promise.all() to make the requests in parallel and load the page faster.
